    ...
    updateContact() {
        const allValid = [...this.template.querySelectorAll('lightning-input')]
            .reduce((validSoFar, inputFields) => {
                ...
                // console.log(inputFields.checkValidity())
                //console.log(validSoFar && inputFields.checkValidity());
...
// console.log('recInput',recordInput)

if(fields[FIRSTNAME_FIELD.fieldApiName] !== this.contact.data.FirstName  || fields[LASTNAME_FIELD.fieldApiName] !== this.contact.data.LastName){
